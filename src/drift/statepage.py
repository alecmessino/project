...
NAV = (
    ...
    '<path d="M1.5 15 H44.5" stroke-width="3.4"/>'
    '<path d="M1.5 1 H4.5 L27 15" stroke-width="2"/>'
    '<path d="M1.5 8 H8 L27 15" stroke-width="2"/>'
    '<path d="M1.5 22 H8 L27 15" stroke-width="2"/>'
    '<path d="M1.5 29 H4.5 L27 15" stroke-width="2"/></svg>'
    ...
    '    </div>\n'
    '    <div class="dwnav-drop">\n'
    '      <button class="dwnav-trigger" type="button">The System<span class="caret" aria-hidden="true"></span></button>\n'
    '      <div class="dwnav-panel">\n'
    ...
    '      <button class="dwnav-trigger" type="button">The Tools<span class="caret" aria-hidden="true"></span></button>\n'
    '      <div class="dwnav-panel">\n'
    ...
    '    </div>\n'
    '  </div>\n'
    '  <a class="dwnav-access" href="private.html">Client Access</a>\n'
    '  <a class="dwnav-cta" href="index.html#conversation">Request a Coordination Review</a>\n'
    '</nav>'
)
