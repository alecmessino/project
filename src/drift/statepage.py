...
_HEAD_CSS = """
  ...
  *{box-sizing:border-box}
  ...
  .capok{background:#eef5f0;border:1px solid #cfe0d6;border-left:3px solid var(--teal2);border-radius:0;padding:14px 16px;font-size:13.5px;color:#244c3f;font-weight:600}
