<!-- ANONYMIZED SUBMISSION COPY. Generated by paper/make_anonymous.py from paper1.md; do not edit by hand. The manuscript of record is paper1.md. -->
...
(Author 2026). That result bears on how the transfer-function timing should be read; it concerns
