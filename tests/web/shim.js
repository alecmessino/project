...
const FIXTURE = {
  ...
  statemap: {
    dimensions: [
      ...
      { key: 'alpha', label: 'Coordination Opportunity', title: "Illustrative after-tax coordination opportunity — dollars per year for every $1M of taxable assets",
    ...
    states: {
      IL: { estate: { regime: 'estate', tag: 'estate', note: 'Illinois estate tax — confirm with counsel.', source: 's' },
            alpha: { regime: 'c', tag: '$40k/$1M', note: 'Illustrative coordination opportunity.', deeplink: 'leakage.html?state=IL', source: 's' } },
