...
ESTATE: dict[str, dict] = {
    ...
    "IL": {"regime": "estate", "top_rate": 0.16, "exemption_usd": 4_000_000, "exemption_display": "$4M", "cliff_kind": "hard",
    ...
    "NY": {"regime": "estate", "top_rate": 0.16, "exemption_usd": 7_160_000, "exemption_display": "$7.16M", "cliff_kind": "phaseout",
    ...
    "MD": {"regime": "both", "top_rate": 0.16, "exemption_usd": 5_000_000, "exemption_display": "$5M",
           "cliff": False, "heir_detail": "the close family is exempt and the 10% inheritance tax reaches other heirs; inheritance tax paid is credited against the estate tax rather than added to it",
           "note": "The only state with both an estate tax ($5M exemption, portable, to 16%) and a 10% inheritance tax on non-close heirs."},
    "KY": {"regime": "inheritance", "top_rate": 0.16, "exemption_usd": None, "exemption_display": "—",
           "cliff": False, "heir_detail": "Class A heirs are exempt; other classes pay 4% to 16%",
           "note": "Inheritance tax only; Class A heirs exempt, others 4–16% by heir class."},
    "NE": {"regime": "inheritance", "top_rate": 0.15, "exemption_usd": None, "exemption_display": "—",
           "cliff": False, "heir_detail": "the rate runs 1% to 15% by heir class, with immediate family at the bottom of the range",
           "note": "County inheritance tax; 1–15% by heir class (post-LB 310)."},
    "NJ": {"regime": "inheritance", "top_rate": 0.16, "exemption_usd": None, "exemption_display": "—",
           "cliff": False, "heir_detail": "Class A heirs are exempt; siblings and others pay 11% to 16%",
           "note": "Estate tax repealed 2018; inheritance tax only, Class A exempt, others 11–16%."},
    "PA": {"regime": "inheritance", "top_rate": 0.15, "exemption_usd": None, "exemption_display": "—",
           "cliff": False, "heir_detail": "a surviving spouse is exempt; lineal heirs pay 4.5%, siblings 12%, and others 15%",
           "note": "Inheritance tax only; lineal heirs 4.5%, siblings 12%, others 15%."},
}
