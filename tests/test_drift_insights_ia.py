...
# Approved masthead families; Fees is a standing top-level link.
FAMILIES = ("Our firm", "Coordination", "The record", "Insights", "For professionals")
...
MASTHEAD = (
    ...
    ("The record", (
        ("Coordination Report", "ic-memo.html"),
        ("Opportunity Register", "opportunity-register.html"),
        ("Wealth Operating Manual", "manual.html"),
        ("90-Day Plan", "transition-plan.html"),
        ("Decision Register", "decision-register.html"),
    )),
    ("Insights", (
...
def test_every_page_carries_the_approved_families():
