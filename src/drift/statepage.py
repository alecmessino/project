...
DISCLOSURE = (
    ...
    'year 2025 and can change — confirm with a tax advisor. Driftwood is the brand of CWS Planning, a '
...
def _jsonld(name: str, code: str, rec: dict, faq: list[dict]) -> str:
    ...
    blocks = [
        {"@context": "https://schema.org", "@type": "FinancialService",
         "name": f"Driftwood — {name} tax-aware investing", "legalName": "CWS Planning",
...
def render_sitemap() -> str:
    ...
    return ('<?xml version="1.0" encoding="UTF-8"?>\n'
            "<!-- Driftwood (CWS Planning) — generated by drift states (src/drift/statepage.py). -->\n"
